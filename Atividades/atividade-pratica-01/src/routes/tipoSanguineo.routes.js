...
router.post('/tipo_sanguineo', auth, tipoSanguineoController.createTipoSanguineo);
...
// ==> Rota responsável por Buscar todos os Tipos Sanguineos: (GET): localhost:3000/api/tipo_sanguineo
router.get('/tipo_sanguineo', auth, tipoSanguineoController.getTipoSanguineo);
...
// ==> Rota responsável por Atualizar um determinado Tipo Saguineo por id: (PUT): localhost:3000/api/tipo_sanguineo/:id
router.put('/tipo_sanguineo/', auth, tipoSanguineoController.updateTipoSanguineo);
