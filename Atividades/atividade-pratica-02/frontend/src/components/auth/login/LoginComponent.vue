			...
			<div class="col-lg-6 offset-lg-3 col-sm-10 offset-sm-1">
				<form class="text-center border border-dark p-5"
					...
					<div class="form-group">
						<input type="text" id="email" name="email" class="form-control mb-5"
					...
					<div class="form-group">
						<input type="password" id="password" name="password" class="form-control mb-5"
					...
					<!--INÍCIO BLOCO: Botão-->
					<center>
						<button @click="submitLoginUser" class="btn btn-dark btn-block  w-75 my-4" cl>
							Entrar
						</button>
					</center>
					<!--FIM BLOCO: Botão-->
